...
export default function NavHeader() {
  return (
    <Suspense fallback={<div>Loading...</div>}>
      <Popover className="relative bg-white nav-header">
        ...
        <div className="flex justify-between items-center border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10">
          ...
          <div className="hidden md:flex items-center justify-end md:flex-1 lg:w-0">
            ...
            <Popover.Button className="bg-white rounded-md p-2 inline-flex items-center justify-center text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500">
              <span className='flex'><MenuIcon className="h-6 w-6"/>
      ...
      >
        <Popover.Panel focus className="absolute top-[1.5rem] -left-[17.5rem] inset-x-0 p-2 transition h-[100px] w-[350px] transform origin-top-right z-50">
